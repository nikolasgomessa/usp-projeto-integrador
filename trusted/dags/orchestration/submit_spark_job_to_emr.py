...
BUCKET_NAME_DEP = dag_params['s3_conf']['bucket_name_dep']
...
#### JARS Conf ######
BUCKET_PREFIX = dag_params["spark_jars_conf"]["bucket_prefix"].format(bucket_name=BUCKET_NAME_DEP)
...
def fetch_cluster_id():
    ...
    cluster_id = emr_hook.get_cluster_id_by_name(emr_cluster_name="trusted",cluster_states=["WAITING", "RUNNING"])
    ####
