...
def fetch_cluster_id():
    ...
    cluster_id = emr_hook.get_cluster_id_by_name(emr_cluster_name="projeto-integrador",cluster_states=["WAITING", "RUNNING"])
    ####
...
with DAG('submit_pyspark_script_to_emr_delivery',
